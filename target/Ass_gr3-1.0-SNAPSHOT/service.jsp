                        ...
                        <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                            ...
                            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                                <div class="navbar-nav mr-auto py-0">
                                    ...
                                    <a href="ServiceServlet" class="nav-item nav-link active">Services</a>
                ...
                <div class="container">
                    <div class="owl-carousel testimonial-carousel py-5">
                        <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
                            <p>The hotel staff was exceptionally friendly and attentive, making our stay comfortable and enjoyable.</p>
                        ...
                        <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
                            <p>The rooms were clean and well-equipped, but the Wi-Fi connection could be improved for a better experience.</p>
                            <div class="d-flex align-items-center">
                        ...
                        <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
                            <p>The location was perfect for sightseeing, though the breakfast options could have been more diverse.</p>
                            <div class="d-flex align-items-center">
