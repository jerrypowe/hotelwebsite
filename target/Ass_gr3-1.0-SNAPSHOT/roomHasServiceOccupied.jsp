...
<html lang="vi">
    ...
    <body>
        ...
        <!--        <div class="text-center">
                    ...
                    <button class="btn btn-outline-light" onclick="redirectToJSP('/readAvailableRoom')">AVAILABLE</button>
                </div>-->
        <div class="header-container">
            <div class="title">
                <h1>ROOM HAS OCCUPIED SERVICE</h1>
            </div>
        ...
        <div class="container">
            ...
            <button class="btn btn-outline-light" onclick="redirectToJSP('/readBookedHasService')">BACK</button>
        </div>
